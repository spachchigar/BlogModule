...
// @ts-ignore 
import { Scaffolding as SampleFoundationScaffolding } from "./Sample.Foundation.model"
// @ts-ignore 
...
// @ts-ignore 
import { HeadlessVariants as SampleFoundationHeadlessVariants } from "./Sample.Foundation.model"
// @ts-ignore 
import { PlaceholderSettings as SampleFoundationPlaceholderSettings } from "./Sample.Foundation.model"
// @ts-ignore 
import { SiteMetadata as SampleFoundationSiteMetadata } from "./Sample.Foundation.model"
...
export namespace Multisite {
    ...
    */
    ...
    /**
    * Represents the template /sitecore/templates/Foundation/JSS Experience Accelerator/Multisite/Headless Solution Template Folder
    */
    export type HeadlessSolutionTemplateFolder = SampleFoundationMultisite.JssSiteFolder &  {
        fields?: {         }

    }

    /**
    * Represents the GraphQL template /sitecore/templates/Foundation/JSS Experience Accelerator/Multisite/Headless Solution Template Folder
    */
    export type HeadlessSolutionTemplateFolderJson = SampleFoundationMultisite.JssSiteFolderJson &  {
    ...
    */
    export type HeadlessTenant = SampleFoundationMultisite.Base.BaseJssTenant &  {
        fields?: {         }
    ...
    */
    export type HeadlessTenantJson = SampleFoundationMultisite.Base.BaseJssTenantJson &  {
...
export namespace Multisite.Folders {

    /**
    * Represents the template /sitecore/templates/Foundation/JSS Experience Accelerator/Multisite/Folders/Placeholder Settings Folder
    */
    export type PlaceholderSettingsFolder =  {
        fields?: {         }
    ...
    /**
    * Represents the GraphQL template /sitecore/templates/Foundation/JSS Experience Accelerator/Multisite/Folders/Placeholder Settings Folder
    */
    export type PlaceholderSettingsFolderJson =  {
...
export namespace Multisite.Folders {
    ...
    /**
    * Represents the template /sitecore/templates/Foundation/JSS Experience Accelerator/Multisite/Folders/Rendering Folder
    */
    export type RenderingFolder =  {
        fields?: {         }

    }

    /**
    * Represents the GraphQL template /sitecore/templates/Foundation/JSS Experience Accelerator/Multisite/Folders/Rendering Folder
    */
    export type RenderingFolderJson =  {
...
export namespace Multisite {
    ...
    */
    export type Site = SampleFoundationScaffolding.Base.SolutionTemplate.SolutionTemplateDescription & 
SampleFoundationScaffolding.Base.SolutionTemplate.SolutionTemplateName &  {
        fields?: { 
            /**
            * Represents the Generate thumbnails field (8700cd8f-83cc-42ba-aa78-65bccab44fc7).
            */
            GenerateThumbnails?: Field<boolean>;

            /**
            * Represents the Point of sale field (9eaf6dc9-b811-4cda-9edd-9697faba628a).
            */
            POS?: Field<string>;

            /**
            * Represents the Project field (36cda943-5589-4405-90bd-b0cf1c0b8450).
            */
            ...
            */
            ...
            /**
            * Represents the Thumbnails root path field (6dd8a774-2ce5-4c9e-be7f-1eaf65789956).
            */
            ThumbnailsRootPath?: Field<string>;
        }
    ...
    */
    export type SiteJson = SampleFoundationScaffolding.Base.SolutionTemplate.SolutionTemplateDescriptionJson & 
SampleFoundationScaffolding.Base.SolutionTemplate.SolutionTemplateNameJson &  {
...
export namespace Scaffolding {
    ...
    */
    export type SolutionTemplate = SampleFoundationScaffolding.Base.SolutionTemplate.SolutionTemplateDescription & 
SampleFoundationScaffolding.Base.SolutionTemplate.SolutionTemplateName &  {
        fields?: { 
            /**
            ...
            */
            ...
            /**
            * Represents the Site Collection Modules field (41ac536a-923a-43f9-ac87-f3993f638125).
            */
            "Tenant Modules"?: Item[];
        }
    ...
    */
    export type SolutionTemplateJson = SampleFoundationScaffolding.Base.SolutionTemplate.SolutionTemplateDescriptionJson & 
SampleFoundationScaffolding.Base.SolutionTemplate.SolutionTemplateNameJson &  {
...
export namespace Scaffolding.Base.SolutionTemplate {

    /**
    * Represents the template /sitecore/templates/Foundation/JSS Experience Accelerator/Scaffolding/Base/Solution template/_SolutionTemplateDescription
    */
    export type SolutionTemplateDescription =  {
        fields?: { 
            /**
            * Represents the Description field (9f437e68-a84d-48ae-8ce1-a3e26c0b5e64).
            */
    ...
    /**
    * Represents the GraphQL template /sitecore/templates/Foundation/JSS Experience Accelerator/Scaffolding/Base/Solution template/_SolutionTemplateDescription
    */
    export type SolutionTemplateDescriptionJson =  {
    ...
    /**
    * Represents the template /sitecore/templates/Foundation/JSS Experience Accelerator/Scaffolding/Base/Solution template/_SolutionTemplateName
    */
    export type SolutionTemplateName =  {
        fields?: { 
            /**
    ...
    /**
    * Represents the GraphQL template /sitecore/templates/Foundation/JSS Experience Accelerator/Scaffolding/Base/Solution template/_SolutionTemplateName
    */
    export type SolutionTemplateNameJson =  {
